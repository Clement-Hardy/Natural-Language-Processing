...
"""
K max pooling base on the paper Hierachical Attentional Hybrid Neural Networks for Document Classification
https://arxiv.org/abs/1901.06610

This implementation taken from https://github.com/luisfredgs/cnn-hierarchical-network-for-document-classification
"""
...
class KMaxPooling(Layer):
    ...
    def __init__(self, k=1, axis=1, **kwargs):
        ...
        # need to switch the axis with the last element
